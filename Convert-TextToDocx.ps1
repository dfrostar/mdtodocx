...
# Run the text to docx converter script
$params = @{
    InputFile = $InputFile
...
try {
    # For now, we're still using the trust inventory script as the converter
    # In future versions, this will be replaced with a more general converter
